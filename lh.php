	...
	if (isset($lastHeard[$i])) {
		...
		if (is_numeric($listElem[2])) {
			...
			if ( $listElem[3] && $listElem[3] != '    ' ) {
				echo "<td align=\"left\"><div style=\"float:left;\"><a href=\"".$callsignLookupUrl.$listElem[2]."\" target=\"_blank\">$listElem[2]</a>/$listElem[3]</div> <div style=\"text-align:right;\">&#40;<a href=\"https://www.gmrs-link.com/map/#!call=".$listElem[2]."*\" target=\"_blank\">GPS</a>&#41;</div></td>";
			} else {
				echo "<td align=\"left\"><div style=\"float:left;\"><a href=\"".$callsignLookupUrl.$listElem[2]."\" target=\"_blank\">$listElem[2]</a></div> <div style=\"text-align:right;\">&#40;<a href=\"https://www.gmrs-link.com/map/#!call=".$listElem[2]."*\" target=\"_blank\">GPS</a>&#41;</div></td>";
			}
		}
